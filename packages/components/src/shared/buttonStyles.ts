...
export const sharedButtonActiveBackgroundClasses =
  "bg-[var(--_lc-button-bg,light-dark(rgb(255_255_255_/_94%),rgb(255_255_255_/_24%)))]";
...
export const sharedButtonHoverTintClasses =
  "hover:bg-[var(--_lc-button-hover-bg,light-dark(rgb(255_255_255_/_98%),rgb(255_255_255_/_30%)))]";
...
export const sharedButtonDisabledClasses =
  "disabled:opacity-55 disabled:cursor-not-allowed disabled:hover:bg-[light-dark(rgb(255_255_255_/_94%),rgb(255_255_255_/_24%))] cursor-pointer";
...
export const sharedButtonPeerCheckedClasses =
  "peer-checked:bg-[light-dark(rgb(255_255_255_/_94%),rgb(255_255_255_/_24%))] peer-checked:text-[light-dark(rgb(15_23_42_/_92%),rgb(255_255_255_/_95%))] peer-checked:hover:bg-[light-dark(rgb(255_255_255_/_98%),rgb(255_255_255_/_30%))]";
